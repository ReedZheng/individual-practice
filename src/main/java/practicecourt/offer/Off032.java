...
/**
 * 输入n个整数，找出其中最小的K个数。例如输入4,5,1,6,2,7,3,8这8个数字，则最小的4个数字是1,2,3,4,。 大/小顶堆，注意：并不能由大/小顶堆直接得到数组中最大/小的元素。
 * 如： 2 /   \ 9     4 / \   / \ 11 12 5   6 思路：将前k个元素构造成大顶堆，然后将后续的元素a依次与大顶堆中最大的元素对比，若a小于最大元素则删除最大的元素并插入a，
 * 否则不做其他操作。
 * <p>
