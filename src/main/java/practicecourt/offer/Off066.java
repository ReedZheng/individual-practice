 ...
 * <p>
 * 这题牛客上边用的是大小顶堆，注意一点：对于海量数据和流的数据，用最大堆和最小堆来管理
 * PriorityQueue 底层数据结构就是小顶堆，重写 comparator 可实现大顶堆
 */
public class Off066 {
     ...
     * 大顶堆
     */
    private PriorityQueue<Integer> maxHeap = new PriorityQueue<>((Integer o1, Integer o2) -> o2 - o1);
