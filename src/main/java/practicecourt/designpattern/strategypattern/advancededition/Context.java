...
public class Context {
    ...
    static {
        // 参数表示在该包下进行扫描
        Reflections reflections = new Reflections("practicecourt.designpattern.strategypattern.advancededition");
        // 获取该包下annotation为参数类型的类并放入set集合中
        Set<Class<?>> typesAnnotatedWith = reflections
            .getTypesAnnotatedWith(practicecourt.designpattern.strategypattern.advancededition.StratefyFlag.class);
